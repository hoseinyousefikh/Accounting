let F225;
function _D() {
    if ($('[class="wrapper toggled"]').length) {
        F225 = 72
    } else if ($('[class="wrapper"]').length) {
        F225 = 255
    }
}
