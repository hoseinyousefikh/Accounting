$(function() {
  ...
  // chart 1
    ...
    var options = {
            ...
            series: [{
                name: 'هزینه های خارجی',
                data: [44, 75, 37, 56, 61, 58, 83, 60, 66]
            }, {
                name: 'هزینه های داخلی',
...
// chart 2
    ...
    var options = {
            ...
            series: [90, 80, 70, 60],
            labels: ['صفحه شغلی', 'رفرال', 'آژانس', 'تابلوهای شغلی']
   ...
   var options = {
    ...
    var options = {
        ...
        dataLabels: {
            ...
            offsetX: -25, // فاصله 10 پیکسل از سمت راست برای داده‌های متنی
            dropShadow: {
                enabled: true
            }
        },
        ...
        xaxis: {
            categories: ['دایرکت', 'گوگل', 'مدیوم', 'گیتهاب', 'راستچین', 'یوتوب', 'مسابقات', 'تی کو', 'فیسبوک', 'لینکدین'],
            labels: {
                rotate: 0,
                style: {
                    direction: 'rtl',
        ...
        yaxis: {
            ...
            reversed: true // معکوس کردن جهت نوار
        },
        tooltip: {
            theme: 'dark',
            x: {
  ...
  // chart 6
    ...
    var options = {
           ...
           toolbar: {
            ...
            title: {
                text: 'ارسال درخواست ماهانه، 1403',
                floating: true,
                offsetY: 0,
                align: 'center',
                style: {
