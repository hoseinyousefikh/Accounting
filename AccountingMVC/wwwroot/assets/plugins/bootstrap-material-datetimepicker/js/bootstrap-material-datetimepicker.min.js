! function(t, e) {
    ...
    e.locale("en"), t.fn[a] = function(e, a) {
        ...
        constructHTMLCalendar: function(t, i) {
            var a = "";
            a += '<div class="dtp-picker-month">' + t.locale(this.params.lang).format("jMMMM jYYYY") + "</div>", a += '<table class="table dtp-picker-days"><thead>';
