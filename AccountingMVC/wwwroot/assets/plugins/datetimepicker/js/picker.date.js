...
DatePicker.prototype.nodes = function( isOpen ) {
    ...
    var
        ...
        // Create the calendar سر میز using a copy of weekday labels collection.
        ...
        tableHead = (function( collection, fullCollection ) {
            ...
            // Create and return the سر میز group.
            return _.node(
                'thead',
                _.node(
                    'tr',
...
weekdaysFull: [ 'یک‌شنبه', 'دو‌شنبه', 'سه‌شنبه', 'چهار‌شنبه', 'پنج‌شنبه', 'جمعه', 'شنبه' ],
